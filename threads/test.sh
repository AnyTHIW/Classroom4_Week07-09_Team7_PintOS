...
# make build/tests/threads/priority-change.resul t
...
# make build/tests/threads/mlfqs/mlfqs-load-60.result
# make build/tests/threads/mlfqs/mlfqs-load-avg.result
# make build/tests/threads/mlfqs/mlfqs-recent-1.result
# make build/tests/threads/mlfqs/mlfqs-fair-2.result
# make build/tests/threads/mlfqs/mlfqs-fair-20.result
# make build/tests/threads/mlfqs/mlfqs-nice-2.result
# make build/tests/threads/mlfqs/mlfqs-nice-10.result
# make build/tests/threads/mlfqs/mlfqs-block.result